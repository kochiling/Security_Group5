                    ...
                    if ($deleted) {
                        ...
                        if (move_uploaded_file($tempname, $folder)) {
                            ...
                            if (mysqli_stmt_execute($stmt)) {
                                ...
                                $log->info('Admin profile picture updated successfully', ['uid' => $id]);
                            } else {
                    ...
                    if ($deleted) {
                        ...
                        if (move_uploaded_file($tempname, $folder)) {
                            ...
                            if (mysqli_stmt_execute($stmt)) {
                                $response['status'] = "success";
                                $response['message'] = "Successfully Updated.";
                                $log->info('Teacher profile picture edited successfully', ['uid' => $id]);
                            } else {
                                $response['status'] = "Error1";
                                $response['message'] = "Error updating database.";
                            }
                    ...
                    if ($deleted) {
                        ...
                        if (move_uploaded_file($tempname, $folder)) {
                            ...
                            if (mysqli_stmt_execute($stmt)) {
                                $response['status'] = "success";
                                $response['message'] = "Successfully Updated.";
                                $log->info('Student profile picture edited successfully', ['uid' => $id]);
                            } else {
                                $response['status'] = "Error1";
                                $response['message'] = "Error updating database.";
                            }
